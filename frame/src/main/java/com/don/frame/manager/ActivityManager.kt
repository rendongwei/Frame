...
class ActivityManager private constructor() {
    ...
    companion object {
        ...
        @Volatile
        private var mManager: ActivityManager? = null
        private val mActivitys: LinkedList<AppCompatActivity> by lazy {
            LinkedList<AppCompatActivity>()
        }

        @Synchronized
        fun getInstance(): ActivityManager {
            mManager = mManager ?: ActivityManager()
            return mManager!!
        }
    }
    ...
    fun addActivity(activity: AppCompatActivity) {
        LogUtil.log(TAG, "addActivity:${activity::class.java.canonicalName}")
        mActivitys.addLast(activity)
    }

    // 移除activity
    fun removeActivity(activity: AppCompatActivity) {
        LogUtil.log(TAG, "removeActivity:${activity::class.java.canonicalName}")
    ...
    // 跳转到邮件
    fun intentToEmail(context: Context, email: String, subject: String, body: String, vararg otherEmail: String) {
